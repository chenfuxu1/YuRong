...
<h3 align="center" style="font-size: 50px">添加新羽绒员工</h3>

<%--新增羽绒记录账单--%>
<div class="outer-div" style="margin-top: 200px" class="">
    <form action="yuRong" method="post">
        <table border="2px" width="900px" cellspacing="0" bordercolor="#000000" style="color: black; font-size: 28px">
            ...
            <tr style="height: 60px">
                ...
                <input name="action" type="hidden" value="addNewYRWork"/>
        ...
        <div class="outer-div">
            <input type="text" id="input_train" name="input_train"
                   style="margin-top: 10px; font-size: 20px; display: none" placeholder="请输入车次"></div>
    </form>
