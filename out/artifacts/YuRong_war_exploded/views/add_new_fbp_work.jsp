...
<h3 align="center" style="font-size: 50px">添加新员工风包皮记录</h3>
...
<div class="outer-div" style="margin-top: 200px">
    <table border="2px" width="900px" cellspacing="0" bordercolor="#000000" style="color: black; font-size: 28px">
        <tr style="background: #FF8C00; height: 60px; ">
            ...
            <th th style="width: 200px; white-space: nowrap">
                工时（天数）
            </th>
        ...
        <tr style="height: 60px">
            <form action="fbp" method="post">
                <input name="action" type="hidden" value="addNewFbpWork"/>
                <td align="center"><input id="workName" style="font-size: 28px; border: none" name="workName"
                                          type="text"
                                          placeholder="姓名"/></td>
                <td align="center"><input id="current-date" style="font-size: 28px; border: none" name="workTime"
                                          type="date"
